...
[docs/extending-items.md](../../docs/extending-items.md) § Combat. Perception and aim numbers are
`content/perception_profile/` and `content/aim_profile/` files bound by `content/agent_profile/`.
