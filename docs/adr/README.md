...
| [ADR-004](ADR-004-detection-model.md) | Sensor-gated detection vs instant wanted level | M4, M8 | **accepted** 2026-09-21 (A) |
...
| [ADR-006](ADR-006-device-time.md) | Does the device pause time? | M5, M6 | **accepted** 2026-09-21 (C) |
| [ADR-007](ADR-007-death-cost.md) | Death cost / kit loss model | M6 | **accepted** 2026-09-22 (C) |
| [ADR-008](ADR-008-arcade-ai.md) | Arcade enemies: same AI retuned, or simpler agent | M4 | **accepted** 2026-09-21 (A) |
| [ADR-009](ADR-009-magazine-model.md) | Magazines as ordered containers | M1, item system | **accepted** 2026-09-20 |
| [ADR-010](ADR-010-hub-interior-simulation.md) | Hub interiors simulated while the player is elsewhere? | M7 | accepted (B) |
