...
| [ADR-002](ADR-002-tick-model.md) | Deterministic fixed tick vs variable step | M0, co-op | proposed |
| [ADR-003](ADR-003-terrain-representation.md) | Heightmap carving vs volumetric voxels | M7, all terrain code | proposed, **close before M1** |
...
| [ADR-009](ADR-009-magazine-model.md) | Magazines as ordered containers | M1, item system | proposed, **close before M1** |
