...
**Accepted: C** (CEOGG, 2026-09-22), as proposed, with the city softening driven by district `law_index` (§7.2) so it
...
Approver: CEOGG
Date: 2026-09-22
Outcome: accepted (verification at the M6 gate: the save round trip with corpse records, the item-conservation property across death, corpse and recovery, and the `m6-death` fixture)
