...
func test_metamorphic_reduced_perception_never_lowers_time_to_alert() -> void:
	...
	for case: int in METAMORPHIC_CASES:
		...
		db.add(&"agent_profile", &"t_base", {"schema_version": 1, "description": "generated", "combat_profile": "arcade", "perception_profile": "t_base", "aim_profile": "guard_sim", "stress_profile": "guard_sim", "stances": [{"stance": "hold", "weight": 1000}]})
		db.add(&"agent_profile", &"t_less", {"schema_version": 1, "description": "generated", "combat_profile": "arcade", "perception_profile": "t_less", "aim_profile": "guard_sim", "stress_profile": "guard_sim", "stances": [{"stance": "hold", "weight": 1000}]})
